...
async function getClubStats() {
  ...
  const { data: activities } = await supabase
    .from("activities")
    .select("runner_id, distance_m, elevation_gain_m")
  ...
  const totals = (activities || []).reduce(
    (acc, a) => {
      ...
      activeRunnerIds.add(a.runner_id);
      return acc;
    },
    { distance: 0, elevation: 0 }
  );

  return { totalRunners, activeRunners: activeRunnerIds.size, ...totals };
}
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .mtc-sponsor-chip { width: 150px; height: 76px; display: flex; align-items: center; justify-content: center; }
        ...
        <div className="mtc-stats-strip">
          <div className="mtc-stats-inner">
            <div className="mtc-stat">
              ...
              <div className="mtc-stat-label">Runners Joined</div>
            </div>
            <div className="mtc-stat">
              <div className="mtc-stat-value">{stats.activeRunners}</div>
              <div className="mtc-stat-label">Active This Month</div>
            </div>
            <div className="mtc-stat">
