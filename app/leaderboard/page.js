  ...
  return (
    <>
      <style>{`
        ...
        .mtc-sponsor-chip { width: 120px; height: 60px; display: flex; align-items: center; justify-content: center; background: #F5F1EA; border-radius: 8px; padding: 8px; box-sizing: border-box; }
